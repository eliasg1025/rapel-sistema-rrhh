        ...
        <>
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    >
                        <Select.Option value={0} key="0">GENERADOS</Select.Option>
                        <Select.Option value={2} key="2">ENVIADO</Select.Option>
                        <Select.Option value={3} key="3">RECEPCIONADO</Select.Option>
                    </Select>
                </div>
                <div className="col-md-4">
                    Búsqueda por DNI:<br />
            ...
            <div className="row">
                <div className="col-md-4">
                    ...
                    <Select
                        ...
                        onChange={e => setFiltro({ ...filtro, goce: e })}
                        style={{
                            width: '100%',
                        }}
                    >
                        ...
                        <Select.Option value={1} key="1">SI</Select.Option>
                    </Select>
                </div>
                {usuario.permisos === 2 && (
                    <div className="col-md-4">
