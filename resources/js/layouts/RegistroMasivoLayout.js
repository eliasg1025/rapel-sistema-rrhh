...
const MainLayout = props => {
    ...
    return (
        <Layout>
            ...
            >
                <br />
                <Menu mode="inline" defaultSelectedKeys={['5']} theme="dark">
...
if (document.getElementById("registro-masivo-layout")) {
    const element = document.getElementById("registro-masivo-layout");
