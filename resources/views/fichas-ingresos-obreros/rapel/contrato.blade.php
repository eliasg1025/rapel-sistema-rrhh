...
@section('contenido')
    ...
    <section style="font-size: 14px">
        ...
        <p>
            El presente documento ha sido elaborado en virtud de lo establecido en el inciso c) del artículo 35° de la Ley N° 29783, Ley de Seguridad y Salud en el Trabajo, indicándose las funciones propias de <b>OBRERO DE CAMPO</b>, a ser desarrolladas por <b>EL TRABAJADOR</b>.
        </p>
        <p>
        ...
        <div style="font-size: 11px">
            <table class="tabla" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>{{ $trabajador->rut }}</td>
                    <td>Nacionalidad:</td>
                    <td>{{ $trabajador->nacionalidad->name }}</td>
                </tr>
                <tr>
                    <td>Fecha de Nacimiento:</td>
                    <td>{{ $trabajador->fecha_format }}</td>
                    <td>Estado Civil:</td>
                    <td>{{ $trabajador->estado_civil->name }}</td>
                </tr>
                <tr>
                    <td>Dirección(1)</td>
