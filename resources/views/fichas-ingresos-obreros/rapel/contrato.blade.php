...
@section('contenido')
    <section id="page1" class="contrato">
        ...
        <ol>
            ...
            <li>
                ...
                <br>5.1	El plazo de vigencia del presente contrato es de tres (3) meses, y rige desde el  hasta el  .
        ...
        <p>En señal de conformidad, las partes suscriben el presente documento por triplicado, en la ciudad de Piura, el .</p>
    ...
    <section>
        ...
        <p>
            El presente documento ha sido elaborado en virtud de lo establecido en el inciso c) del artículo 35° de la Ley N° 29783, Ley de Seguridad y Salud en el Trabajo, indicándose las funciones propias de OBRERO DE CAMPO, a ser desarrolladas por EL TRABAJADOR.
        </p>
        <p>
        ...
        <div>
            <p>EL EMPLEADOR</p>
            <p>EL TRABAJADOR <br> DNI: 72437334</p>
        </div>
    </section>
    ...
    <section id="page6">
        <h4>DECLARACIÓN JURADA DE NO TENER ANTECEDENTES POLICIALES, PENALES NI JUDICIALES </h4>
        <br>
        <p>
            YO, {{ $trabajador->nombre_completo }} IDENTIFICADO(A) CON DNI Nº {{ $trabajador->rut }} CON DOMICILIO REAL EN {{ $trabajador->direccion }} DEL DISTRITO DE {{ $trabajador->distrito->name }}, PROVINCIA {{ $trabajador->distrito->provincia->name }} Y DEPARTAMENTO {{ $trabajador->distrito->provincia->departamento->name }}, AL AMPARO DE LO PREVISTO EN EL ARTÍCULO 41° DE LA LEY N° 27444, LEY DEL PROCEDIMIENTO ADMINISTRATIVO GENERAL, EN APLICACIÓN DEL PRINCIPIO DE PRESUNCIÓN DE LA VERACIDAD; DECLARO BAJO JURAMENTO:
        </p>
        <ul>
        ...
        <p>Piura, 03 de Junio del 2020.</p>
        <div>
            <div>
                <p>HUELLA DIGITAL <br> (INDICE DERECHO)</p>
            </div>
            <div>
                <p>FIRMA DEL TRABAJADOR <br> DNI/CE: {{ $trabajador->rut }}</p>
            </div>
        </div>
    </section>
    ...
    <section id="page8">
        <h4>CONVENIO DE AUTORIZACIÓN PARA LA TRAMITACIÓN DE ANTECEDENTES POLICIALES </h4>
        <p>
            Conste por el presente documento, el CONVENIO DE AUTORIZACIÓN PARA LA TRAMITACIÓN DE ANTECEDENTES POLICIALES (en adelante “EL CONVENIO”) que suscriben de una parte SOCIEDAD AGRICOLA RAPEL SAC, identificado con RUC Nº 20451779711, inscrita en la Partida Electrónica N° 12619278, del Registro de Personas Jurídicas de Lima, con domicilio en Caserío el Papayo Mz O, Distrito de Castilla, debidamente representada por el Jefe de Recursos Humanos, Carrillo Curay Federico, identificado con D.N.I N° 44554215, a quien en lo sucesivo se denominará EL EMPLEADOR, y de la otra parte RUFINO ALAMA LUIS, identificado (a) con D.N.I. N° {{ $trabajador->rut }}, con domicilio en {{ $trabajador->direccion }}, a quien en adelante se le denominará EL TRABAJADOR, en los términos y condiciones siguientes:
        </p>
        <ul>
            <li>
                PRIMERO: ANTECEDENTES<br>
                EL EMPLEADOR dentro de su Política de Contratación, en el artículo 2° establece los requisitos aplicables todos los trabajadores sin distinción  del cargo que ocupan y la naturaleza de sus funciones. Superado el proceso de selección EL EMPLEADOR,  conforme lo dispuesto en la Ley 29607, exige a EL TRABAJADOR la presentación del certificado de antecedentes policiales. </li>
            <li>
                SEGUNDO: OBJETO DEL CONVENIO<br>
                EL EMPLEADOR con la finalidad de otorgar facilidades suscribe el presente convenio, mediante el cual EL TRABAJADOR  autoriza expresamente a EL EMPLEADOR  la tramitación y obtención del certificado de antecedentes policiales.
            </li>
            <li>
                TERCERO: DEL COSTO DE LOS CERTIFICADOS<br>
                EL TRABAJADOR será quien asuma el costo de los certificados de antecedentes policiales, siendo el importe de S/. 11.00 (ONCE CON 00/100 SOLES), el cual será descontado de su remuneración en una (1) sola cuota, en el mes de JUNIO - 2020.

                EL TRABAJADOR conoce y entiende que en el supuesto que se compruebe que mantiene deuda por el trámite de antecedentes policiales, el  costo será descontado del pago por los días efectivamente laborados  o de la liquidación de beneficios sociales respectiva o, por lo cual EL TRABAJADOR deja expresa constancia que autoriza a EL EMPLEADOR a realizar el descuento que corresponda.
            </li>
            <li>
                CUARTO:<br>
                ...
                En señal de conformidad, suscriben el presente documento las partes, en Piura, al 03 de Junio del 2020 .
            </li>
        </ul>
        <div>
            <div>
    ...
    <section id="page10">
        <h4>CONSTANCIA DE ENTREGA DE REGLAMENTO INTERNO DE TRABAJO</h4>
        <p>
            Yo, _________________________________________________ <br>
            Identificado con D.N.I N° ___________________________, manifiesto haber recibido un ejemplar del Reglamento Interno de Trabajo, comprometiéndome a leerlo, estudiarlo y cumplirlo, durante la vigencia del vínculo laboral que mantengo con La Empresa.<br>
            Me comprometo voluntariamente a difundir y velar por su cumplimiento entre mis compañeros de trabajo.
        </p>
        <div>
            <div>
                <p>FIRMA<br>DNI: {{ $trabajador->rut }}</p>
            </div>
            <div>
                <p>Piura,  03 de Junio del 2020.</p>
                <div></div>
        ...
        <small>Prohibida la reproducción total o parcial de este documento<br>sin autorización de  SOCIEDAD AGRICOLA RAPEL S.A.C.</small>
    </section>
    ...
    <section id="page12">
        <span>REGLAMENTO INTERNO DE SEGURIDAD Y SALUD EN EL TRABAJO </span>
        <h4 class="titulo">DECLARACIÓN DE ACEPTACIÓN DEL REGLAMENTO INTERNO DE SEGURIDAD  Y SALUD EN EL TRABAJO</h4>
        <br>
        <p>
            Yo, {{ $trabajador->nombre_completo }}, identificado con DNI N° {{ $trabajador->rut }}, desempeñándome en el cargo de OBRERO DE CAMPO, declaro que desarrollare mis labores en forma segura, comprometiéndome a cumplir y acatar todas las normativas y procedimientos de Seguridad y Salud en el Trabajo establecidas por la Empresa en el presente Reglamento y demás directivas o políticas internas; siendo esto condición imprescindible para mi permanencia en la Empresa.
        </p>
        <p>
        ...
        <p>
            <b>El Papayo, 03 de Junio del 2020</b>
        </p>
        <div>
            <div>
                <p>
    ...
    <section id="page16" style="font-size: 13px">
        ...
        <p>Relator (es): SALAZAR CAMPOS KARLA MAGALY.</p>
        <p>
        ...
        <ul>
            ...
            <li>Verificar antes de ingresar a un cuartel que no tenga bandera Roja (peligro no entrar por 48 horas), bandera Amarrilla (peligro no comer) y bandera verde (autorizado a cosechar – fruta libre de químicos). </li>
        ...
        <p>
            NUESTRO DEBER ES HACER CUMPLIR LAS NORMAS DE LA EMPRESA<br>
            Estamos en pleno conocimiento de los riesgos típicos de las labores que desempeñaremos en las instalaciones, informado por nuestro Jefe directo y Aseguramiento de calidad.
        </p>
        <div>
            <table>
                <tr>
                    <td>NOMBRE</td>
                    <td>RUFINO ALAMA, LUIS </td>
                </tr>
                <tr>
                    <td>FIRMA</td>
                    <td></td>
    ...
    <section id="page18" style="font-size: 14px">
        <h4 class="titulo">FICHA DE INGRESO Y CONTRATACIÓN</h4>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td>Distrito:</td>
                <td>{{ $trabajador->distrito->name }}</td>
            </tr>
            <tr>
                <td>Telf./Celular:</td>
            ...
            <tr>
                ...
                <td>{{ $trabajador->zona_labor->name ?? '-' }}</td>
            </tr>
            <tr>
                <td>Departamento:</td>
                <td></td>
            ...
            <tr>
                ...
                <td><b>03 de Junio del 2020</b></td>
                <td>Troncal:</td>
                <td>ALTO PIURA</td>
                <td>Ruta:</td>
                <td>SANTA ANA</td>
            ...
            <tr>
                ...
                <td> </td>
                <td>Hora:</td>
                <td>6:15 am a 15:15am - 11:00am a 15:00pm</td>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                ...
                <td>V°B° Gerente General y/o Recursos Humanos </td>
            </tr>
        </table>
    ...
    <section id="page19">
        <h4>FORMATO DE ELECCIÓN DEL SISTEMA PENSIONARIO</h4>
        <br>
        <ol>
            <li>
            ...
            <li>
                DATOS DE LA ENTIDAD EMPLEADORA<br>
                <ol>
                    <li>NOMBRE O RAZON SOCIAL: <span>SOCIEDAD AGRICOLA RAPEL SAC</span></li>
                    <li>N° DE RUC: <span>20451779711 </span></li>
                    <li>DEPARTAMENTO DEL DOMICILIO FISCAL: <span>CASERIO EL PAPAYO MZ "O"-CASTILLA-PIURA</span></li>
                </ol>
            </li>
            <li>
                DATOS DEL VÍNCULO LABORAL<br>
                <ol>
                    <li>FEHCA DE INICIO DE LA RELACION: <span>03 de Junio del 2020</span></li>
                    <li>REMUNERACIÓN: <span>S/ 39.19</span></li>
                </ol>
            </li>
            <li>
                ELECCIÓN DEL SISTEMA PENSIONARIO<br>
                <ol>
                    <li>
                    ...
                    <li>
                        ...
                        <table>
                            <tr>
                                <td>INTEGRA <span></span></td>
                                <td>PRIMA <span></span></td>
                            </tr>
                            <tr>
                                <td>PROFUTURO <span></span></td>
                                <td>HABITAT <span></span></td>
                            </tr>
                            <tr>
                                <td>HORIZONTE <span></span></td>
                                <td>O.N.P. <span></span></td>
                            </tr>
                        </table>
                    </li>
                </ol>
        ...
        <div>
            ...
            <div>
                <p>Firma del Trabajador: _______________________</p>
                <p>Piura, 03 de Junio de 2020</p>
            </div>
        </div>
        <small>{{ $trabajador->rut }}</small>
    </section>
    ...
    <section id="page21">
        ...
        <table>
            <tr>
                ...
                <td>
                    Fecha de Ingreso:<br>
                    <span>03 de Junio del 2020</span>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <section id="page22">
        ...
        <div>
            ...
            <p>Fecha de recepción: 03 de Junio de 2020</p>
        </div>
